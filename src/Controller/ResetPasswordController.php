...
class ResetPasswordController extends AbstractController
{
    ...
    public function request(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->processSendingPasswordResetEmail($email, $mailer, $fromEmail);
        }

        return $this->render('reset_password/request.html.twig', [
            'requestForm' => $form,
            'generalCineNetwork' => $cineNetwork,
        ]);
    }
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, string $fromEmail): RedirectResponse
    {
        ...
        $email = (new TemplatedEmail())
            ->from(new Address($fromEmail, 'La Ciné Network'))
