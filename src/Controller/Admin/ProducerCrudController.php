...
class ProducerCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setEntityLabelInSingular('Intervenant Réalisateurs')
            ->setEntityLabelInPlural('Intervenants Réalisateurs')
    ...
    public function configureActions(Actions $actions): Actions
    {
        $exportCsvAction = Action::new('exportCsv', 'Exporter en CSV', 'fa fa-download')
            ->linkToRoute('export_speakers_realisateur_csv')
    ...
    public function createIndexQueryBuilder($searchDto, $entityDto, $fields, $filters): QueryBuilder
    {
        ...
        return $qb->andWhere('entity.typeSpeaker = :realisateurType')
            ->setParameter('realisateurType', 'Réalisateur');
    }
    ...
    #[Route('/export-speakers-realisateur-csv', name: 'export_speakers_realisateur_csv')]
    public function exportCsv(CsvExporterService $csvExporter, ManagerRegistry $doctrine): Response
    {
        ...
        return $csvExporter->export($data, $headers, 'export-de-tous-les-intervenants-de-type-realisateur.csv');
    }
}
