...
class ExpiredAnnouncementCrudController extends AbstractCrudController
{
    ...
    public function createIndexQueryBuilder(SearchDto $searchDto, EntityDto $entityDto, FieldCollection $fields, FilterCollection $filters): QueryBuilder
    {
        ...
        $qb->andWhere('entity.expiryAnnouncement < :today')
    ...
    {
        return $crud
            ->setEntityLabelInPlural('Annonces expirées')
            ->setEntityLabelInSingular('Annonce expirée')
            ->setDefaultSort(['expiryAnnouncement' => 'DESC']);
    }
        ...
        return [
            ...
            DateTimeField::new('expiryAnnouncement', 'Fin')
                ...
                ->formatValue(function ($value) {
                    ...
                    return sprintf('<span style="color:red;">%s</span>', $value->format('d/m/Y'));
                }),
