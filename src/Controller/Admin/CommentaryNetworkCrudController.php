...
class CommentaryNetworkCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setEntityLabelInPlural('Commentaires sur les événements')
            ->setEntityLabelInSingular('Commentaire sur l\'événement')
    ...
    public function createIndexQueryBuilder(
        ...
        return $qb
            ->andWhere('entity.archivedEvent IS NOT NULL')
            ->andWhere('entity.netPitchFormation IS NULL');
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            FormField::addTab('Événement associé')->setIcon(''),
