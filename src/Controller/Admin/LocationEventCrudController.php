...
class LocationEventCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setEntityLabelInSingular('Lieu Événement')
            ->setEntityLabelInPlural('Lieux Événements')
    ...
    public function createEntity(string $entityFqcn)
    {
        ...
        $location->setTypeLocation('Événement');
        return $location;
    }
}
