...
class ProposalCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setEntityLabelInSingular('Intervenant externe')
            ->setEntityLabelInPlural('Intervenants externes')
    ...
    public function configureActions(Actions $actions): Actions
    {
        $exportCsvAction = Action::new('exportCsv', 'Exporter en CSV', 'fa fa-download')
            ->linkToRoute('export_speakers_externe_csv')
    ...
    public function createIndexQueryBuilder($searchDto, $entityDto, $fields, $filters): QueryBuilder
    {
        ...
        return $qb->andWhere('entity.typeSpeaker = :internType')
            ->setParameter('internType', 'Externe');
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        return [
            ...
            TextField::new('telSpeaker', 'Téléphone')
                ->setRequired(true)
                ->setHelp('<small>Numéro de téléphone de l’intervenant. Il sera utilisé pour le contact direct.</small>'),
            TextField::new('emailSpeaker', 'Email')
                ->setRequired(true)
                ->setHelp('<small>Adresse email de l’intervenant. Il sera utilisé pour le contact direct.</small>'),
            ...
            AssociationField::new('shortFilms', 'Courts-métrages associés')
                ...
                ->renderAsHtml(),
            ChoiceField::new('statutSpeaker', 'Statut de l’intervenant')->setChoices(['Proposé' => 'Proposé', 'Validé' => 'Validé'])
        ...
        <strong>Format conseillé :</strong> carré ou horizontal, PNG ou WebP avec fond transparent.
            ...
            ChoiceField::new('imgSpeakerProposal1', 'Photo proposée N°1')
                ->setChoices(array_combine($profileImages, $profileImages))
                ->onlyOnForms()
                ->setHelp('<small>
        Sélectionnez une image déjà présente dans le dossier <code>/externe-profil/</code>.<br>
        Cette image apparaîtra sur les fiches intervenants. <br>
        <strong>Format conseillé :</strong> JPG ou WebP, visage centré, format portrait.
    </small>'),
            ImageField::new('imgSpeakerProposal1', 'Photo proposée N°1')
                ->setBasePath('/images/intervenants/realisateur-et-stagiaire/realisateur-et-stagiaire-profil/')
                ->setUploadDir('public/images/intervenants/realisateur-et-stagiaire/realisateur-et-stagiaire-profil/')
                ->onlyOnIndex(),
            ...
            ChoiceField::new('imgSpeakerProposal2', 'Photo proposée N°2')
                ->setChoices(array_combine($profileImages, $profileImages))
                ->onlyOnForms()
                ->setHelp('<small>
        Sélectionnez une image déjà présente dans le dossier <code>/externe-profil/</code>.<br>
        ...
        <strong>Format conseillé :</strong> JPG ou WebP, visage centré, format portrait.
            ...
            ImageField::new('imgSpeakerProposal2', 'Photo proposée N°2')
                ->setBasePath('/images/intervenants/realisateur-et-stagiaire/realisateur-et-stagiaire-profil/')
                ->setUploadDir('public/images/intervenants/realisateur-et-stagiaire/realisateur-et-stagiaire-profil/')
                ->onlyOnIndex(),
            ...
            ChoiceField::new('imgSpeakerProposal3', 'Photo proposée N°3')
                ->setChoices(array_combine($profileImages, $profileImages))
                ->onlyOnForms()
                ->setHelp('<small>
        Sélectionnez une image déjà présente dans le dossier <code>/externe-profil/</code>.<br>
        ...
        <strong>Format conseillé :</strong> JPG ou WebP, visage centré, format portrait.
            ...
            ImageField::new('imgSpeakerProposal3', 'Photo proposée N°3')
                ->setBasePath('/images/intervenants/realisateur-et-stagiaire/realisateur-et-stagiaire-profil/')
                ->setUploadDir('public/images/intervenants/realisateur-et-stagiaire/realisateur-et-stagiaire-profil/')
                ->onlyOnIndex(),
    ...
    #[Route('/export-speakers-externe-csv', name: 'export_speakers_externe_csv')]
    public function exportCsv(CsvExporterService $csvExporter, ManagerRegistry $doctrine): Response
    {
        ...
        return $csvExporter->export($data, $headers, 'export-de-tous-les-intervenants-de-type-externe.csv');
    }
}
